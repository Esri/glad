/*
    ...
    OpenGL, OpenGL ES loader generated by glad 0.1.12a0 on Tue Sep 20 17:52:17 2016.

    Language/Generator: C/C++
    Specification: gl
    APIs: gles2=3.2, gl=4.5
    Profile: core
    Extensions:
        GL_3DFX_multisample,
        GL_3DFX_tbuffer,
...
int gladLoadGLES2Loader(GLADloadproc loadCore, GLADloadproc loadExtension){
	...
	load_GL_EXT_texture_filter_minmax(loadExtension);
